...
void groapa(int origx, int origy) {
	glColor3f(0.2, 0.2, 0.2);
	glBegin(GL_POLYGON);
		glVertex2i(0 + origx, 0 + origy);
		glVertex2i(40 + origx, -20 + origy);
		glVertex2i(60 + origx, 0 + origy);
		glVertex2i(60 + origx, 60 + origy);
		glVertex2i(20 + origx, 40 + origy);
		glVertex2i(0 + origx, 60 + origy);
	glEnd();
